...
public class ThuocDAO  extends PlusDAO<Thuoc, String>{
    String INSERT_SQL = "insert into Thuoc(MaThuoc,Tenthuoc, HDS, DonVi) values(?,?,?,?)";
    ...
    Xjdbc.update(INSERT_SQL,entity.getMaThuoc(),entity.getTenthuoc(),entity.getHSD(),entity.getDVT());
            
    }

    @Override
    public void update(Thuoc entity) {
        Xjdbc.update(UPDATE_SQL,entity.getTenthuoc(),entity.getHSD(),entity.getDVT(),entity.getMaThuoc());
    }
